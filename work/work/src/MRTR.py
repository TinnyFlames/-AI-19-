...
class MRTR():
    ...
    def after_backward(self,iteration,logs,epoch,progbar,images,images_gt,images_gen):
    ...
    def train_epoc(self):
        ...
        while keep_training:
            ...
            for items in train_loader:
                ...
                logs = self.after_backward(iteration,logs,epoch,progbar,images,images_gt,images_gen)
...
if __name__ == "__main__":
    config = Config("/home/aistudio/work/config/config.yml")
    config.mode = 'train'
    model = MaskInpaintModel(config)
    params_info = paddle.summary(model,[(1,3,512,512),(1,1,512,512),(1,1,512,512)])
    print(params_info)